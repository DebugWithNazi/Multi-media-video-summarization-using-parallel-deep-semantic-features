...
if (video_name not in videoDict):
    ...
    datasetsH5 = h5py.File(".\\custom_data\\dataset_summe_processed.h5",
                           'r')
    seq1 = datasetsH5['video_1']['features'][...]
    seq2 = datasetsH5['video_1']['features_flow'][...]  # np.load(".\\custom_data\\data_input_flow_Sultan_Sanjar_1.npy")  # you can provide features from another video
    seq3 = datasetsH5['video_1']['features_rgb'][...]  # np.load(".\\custom_data\\data_input_rgb_Sultan_Sanjar_1.npy")
